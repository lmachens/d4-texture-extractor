...
const bpp = [
  0, 128, 128, 128, 128, 96, 96, 96, 96, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64,
  64, 64, 64, 64, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
  32, 32, 32, 32, 32, 32, 32, 32, 32, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
  16, 16, 8, 8, 8, 8, 8, 8, 1, 32, 32, 32, 4, 4, 4, 8, 8, 8, 8, 8, 8, 4, 4, 4,
  8, 8, 8, 16, 16, 32, 32, 32, 32, 32, 32, 32, 8, 8, 8, 8, 8, 8, 0, 0, 0, 0, 0,
...
function convertRawTexture(textureFilePath, ddsFilePath, textureData) {
  ...
  const realWidth =
    textureData.dwMipMapLevelMin > 0
      ? textureData.dwWidth * Math.pow(2, textureData.dwMipMapLevelMin)
      : textureData.dwWidth;
  const realHeight =
    textureData.dwMipMapLevelMin > 0
      ? textureData.dwHeight * Math.pow(2, textureData.dwMipMapLevelMin)
      : textureData.dwHeight;
